...
@Component({
        ...
        <div class="auth-card">
            ...
            @if (statusError()) {
                <div class="alert alert-danger">
                    @if (statusError() === 'suspended') {
                        <span>⚠️ Your account has been suspended. Please contact your administrator.</span>
                    } @else if (statusError() === 'disabled') {
                        <span>🚫 Your account has been disabled. Please contact your administrator.</span>
                    }
                </div>
            }
            ...
            <!-- Google Sign In -->
            <button class="btn btn-google" (click)="onGoogleLogin()" [disabled]="isLoading()">
    ...
    styles: [`
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 3px var(--accent-100, #e0e7ff);
        }
        ...
        .checkbox-label input { accent-color: var(--accent-500, #6366f1); }
        .forgot-link {
            color: var(--accent-600, #4f46e5);
            font-size: 0.875rem;
            text-decoration: none;
        }
        .forgot-link:hover { color: var(--accent-700, #4338ca); }
        .btn {
            width: 100%;
            padding: 0.7rem;
            border-radius: var(--radius-sm, 6px);
...
export class LoginComponent {
    ...
    constructor() {
        this.route.queryParams.subscribe(params => {
            if (params['error']) this.statusError.set(params['error']);
        });
